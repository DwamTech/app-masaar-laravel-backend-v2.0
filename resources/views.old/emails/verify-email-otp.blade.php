...
<head>
    ...
    <style>
        body { font-family: Tahoma, Arial, sans-serif; background:#f6f6f6; color:#222; margin:0; padding:20px; }
        ...
        .header { padding:20px 24px; background:#0f6efd; color:#fff; }
        .brand { font-size:18px; font-weight:bold; }
        .content { padding:24px; line-height:1.9; }
...
<body>
    <div class="container">
        <div class="header">
            <div class="brand">مكتب الغروب للعقارات</div>
        </div>
        <div class="content">
