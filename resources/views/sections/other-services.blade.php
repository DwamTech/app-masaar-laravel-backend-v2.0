    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="page-subtitle mb-0">
                            ...
                            Other Services Lists Management 
                        </p>
                    </div>
            ...
            <div class="row" id="specsGrid">
                <!-- سيتم ملء هذه القائمة ديناميكياً: المناطق -->
            </div>
        </div>
    </div>
</div>
    ...
    const dummySpecs = [
        {
            ...
            options: ['وسط المدينة', 'مارينا', 'جميرا', 'ديرة', 'بر دبي', 'الخليج التجاري', 'الجداف', 'البرشاء', 'أم سقيم', 'الصفوح', 'الكرامة', 'القصيص'],
            is_active: true,
            sort_order: 1
        }
    ];
