    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row" id="specsGrid">
                <!-- سيتم ملء هذه القوائم الثنتين ديناميكياً: المناطق ونوع العقد -->
            </div>
        </div>
    </div>
</div>
    ...
    const dummySpecs = [
        {
            ...
            options: ['وسط المدينة', 'مارينا', 'جميرا', 'ديرة', 'بر دبي', 'الخليج التجاري', 'الجداف', 'البرشاء', 'أم سقيم', 'الصفوح'],
            is_active: true,
            sort_order: 1
        },
        {
            field_name: 'contract_type',
            display_name: 'نوع العقد - Contract Type',
            options: ['بيع', 'إيجار', 'إيجار سنوي', 'إيجار شهري', 'إيجار يومي', 'تمليك', 'استثمار', 'شراكة'],
            is_active: true,
            sort_order: 2
        }
    ];
