    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="page-title">
                         ...
                         الإمارات والمناطق ونوع الخدمة
                        </h1>
                        <p class="page-subtitle mb-0">
                            <i class="bi bi-gear me-2"></i>
                            Car Services Lists Management 
                        </p>
                    </div>
                    <div class="d-flex gap-3 align-items-center">
                        <div class="stats-badge">
                            <i class="bi bi-list-check me-1"></i>
                            <span id="totalSpecs">0</span> قائمة
                        </div>
            ...
            <div class="row" id="specsGrid">
                <!-- سيتم ملء هذه القوائم الثلاث ديناميكياً: الإمارات والمناطق ونوع الخدمة -->
            </div>
        </div>
    </div>
</div>
...
const REQUIRED_FIELDS = [
    'emirate', 'districts', 'service_type'
];
...
function getFieldIcon(fieldName) {
    const iconMap = {
        'emirate': 'geo-alt-fill',
        'districts': 'map-fill',
        'service_type': 'tools'
    };
    
    return iconMap[fieldName] || 'gear-fill';
}
...
function getArabicDisplayName(fieldName) {
    const arabicNames = {
        ...
        'service_type': 'نوع الخدمة - Service Type'
    };
    ...
    const dummySpecs = [
        {
            ...
            options: ['دبي', 'أبوظبي', 'الشارقة', 'عجمان', 'رأس الخيمة', 'الفجيرة', 'أم القيوين'],
            is_active: true,
            sort_order: 1
        },
        {
            field_name: 'districts',
            display_name: 'المناطق - Districts',
            options: ['وسط المدينة', 'مارينا', 'جميرا', 'ديرة', 'بر دبي', 'الخليج التجاري'],
            is_active: true,
            sort_order: 2
        },
        {
            field_name: 'service_type',
            display_name: 'نوع الخدمة - Service Type',
            options: ['صيانة عامة', 'إصلاح المحرك', 'صيانة الفرامل', 'تغيير الزيت', 'فحص شامل', 'إصلاح التكييف'],
            is_active: true,
            sort_order: 3
        }
    ];
