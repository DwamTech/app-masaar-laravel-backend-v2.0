                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="page-title">
                            ...
                            إدارة مواصفات بيع السيارات
                        </h1>
                        <p class="page-subtitle mb-0">
                            <i class="bi bi-gear me-2"></i>
                            Car Sales Specifications Management
                        </p>
                    </div>
...
const REQUIRED_FIELDS = [
    'km', 'specs', 'car_type', 'trans_type', 'fuel_type', 'color', 'interior_color',
    'warranty', 'engine_capacity', 'cylinders', 'horse_power', 'doors_no', 'seats_no', 'steering_side'
];
...
function getArabicDisplayName(fieldName) {
    const arabicNames = {
        ...
        'engine_capacity': 'سعة المحرك - Engine Capacity',
        'cylinders': 'عدد الأسطوانات - Cylinders',
        'horse_power': 'القوة الحصانية - Horse Power',
        'doors_no': 'عدد الأبواب - Number of Doors',
        'seats_no': 'عدد المقاعد - Number of Seats',
        'steering_side': 'جهة المقود - Steering Side'
    };
...
function loadDummyData() {
    const dummySpecs = [
        {
            field_name: 'km',
            display_name: 'الكيلومترات - Kilometers',
            options: ['0-10000', '10000-50000', '50000-100000', '100000-200000', '200000+'],
            is_active: true,
            sort_order: 1
        },
        {
            field_name: 'specs',
            display_name: 'المواصفات - Specifications',
            options: ['فل كامل', 'نص فل', 'ستاندر', 'سبورت', 'لوكس'],
            is_active: true,
            sort_order: 2
        },
        {
            ...
            options: ['سيدان', 'هاتشباك', 'SUV', 'كوبيه', 'كونفرتيبل', 'بيك أب'],
            is_active: true,
            sort_order: 3
        },
        {
            ...
            options: ['أوتوماتيك', 'مانيوال', 'CVT', 'تيبترونيك'],
            is_active: true,
            sort_order: 4
        },
        {
            ...
            options: ['بنزين', 'ديزل', 'هايبرد', 'كهربائي', 'غاز طبيعي'],
            is_active: true,
            sort_order: 5
        },
        {
            ...
            options: ['أبيض', 'أسود', 'فضي', 'رمادي', 'أحمر', 'أزرق', 'ذهبي', 'بني'],
            is_active: true,
            sort_order: 6
        },
        {
            ...
            options: ['أسود', 'بيج', 'رمادي', 'بني', 'أحمر', 'أبيض'],
            is_active: true,
            sort_order: 7
        },
        {
            field_name: 'warranty',
            display_name: 'الضمان - Warranty',
            options: ['بدون ضمان', 'ضمان الوكالة', 'ضمان شامل', 'ضمان محدود'],
            is_active: true,
            sort_order: 8
        },
        {
            field_name: 'engine_capacity',
            display_name: 'سعة المحرك - Engine Capacity',
            options: ['1.0L', '1.2L', '1.4L', '1.6L', '1.8L', '2.0L', '2.4L', '3.0L', '4.0L+'],
            is_active: true,
            sort_order: 9
        },
        {
            field_name: 'cylinders',
            display_name: 'عدد الأسطوانات - Cylinders',
            options: ['3', '4', '6', '8', '12'],
            is_active: true,
            sort_order: 10
        },
        {
            ...
            display_name: 'القوة الحصانية - Horse Power',
            options: ['أقل من 100', '100-150', '150-200', '200-300', '300-400', 'أكثر من 400'],
            is_active: true,
            sort_order: 11
        },
        {
            field_name: 'doors_no',
            display_name: 'عدد الأبواب - Number of Doors',
            options: ['2', '3', '4', '5'],
            is_active: true,
            sort_order: 12
        },
        ...
        {
            field_name: 'steering_side',
            display_name: 'جهة المقود - Steering Side',
            options: ['يمين', 'يسار'],
            is_active: true,
            sort_order: 14
        }
