<div id="send-notification-modal" class="modal-overlay" style="display:none;" aria-hidden="true">
    <div class="modal">
        <div class="modal-header">
            <div class="modal-title">
                <i class="bi bi-send"></i>
                <span>إرسال إشعار مخصص</span>
            </div>
            <button class="modal-close" id="send-modal-close" aria-label="إغلاق">
                <i class="bi bi-x"></i>
            </button>
        </div>

        <div class="modal-body">
            <!-- Step 1: Eligible Users List -->
            ...
            <section id="result-view" style="display:none;">
                ...
                <div class="compose-actions">
                    ...
                    <button id="close-result" class="primary-btn"><i class="bi bi-check2-circle"></i>تم</button>
                </div>
            </section>
        </div>
    </div>
